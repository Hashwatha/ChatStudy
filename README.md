...
```
## OUTPUT
![image](https://github.com/user-attachments/assets/ac82b2b4-24a7-4bca-806f-daee60ce4601)
## Server
```
import socket
s=socket.socket()
...
```
## OUTPUT
![image](https://github.com/user-attachments/assets/3625552b-9aa8-4022-a443-c34f6c7d5ff1)
## Result:
